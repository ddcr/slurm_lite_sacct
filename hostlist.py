...
# DDCR- 04-06-2017
# Cleaned code to obey PEP 8 style guide
...
def pd_collect_hosts(args):
    ...
    res = func_union(func_args)
    res = numerically_sorted(res)
    try:
        res = collect_hostlist(res)
    except BadHostlist, e:
        raise ("Bad hostname encountered: {}\n".format(e.args))
    return res


if __name__ == '__main__':
    # import numpy as np
    # host_num = np.random.randint(2, 107, 43)
    # hosts = ['veredas{}'.format(hn) for hn in host_num]
    # print hosts
