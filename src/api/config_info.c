                            ...
                            slurm_ctl_conf_info_msg_t * slurm_ctl_conf_ptr )
{
	...
	fprintf(out, "SlurmEventHandler = %s\n",
		slurm_ctl_conf_ptr->slurm_event_handler);
	fprintf(out, "SlurmEventHandlerLogfile = %s\n",
		slurm_ctl_conf_ptr->event_handler_logfile);
	fprintf(out, "SlurmEventHandlerPollInterval = %u\n",
		slurm_ctl_conf_ptr->event_handler_poll_interval);
	/*  NLK event handler changes */
