...
_pack_slurm_ctl_conf_msg(slurm_ctl_conf_info_msg_t * build_ptr, Buf buffer)
{
	...
	/* nlk Changes */
	pack16(build_ptr->event_handler_poll_interval, buffer);
	packstr(build_ptr->slurm_event_handler, buffer);
	packstr(build_ptr->event_handler_logfile, buffer);
	/*nlk Changes */
			   ...
			   build_buffer_ptr, Buf buffer)
{
	...
	*build_buffer_ptr = build_ptr;
	...
	/* nlk changes */
	safe_unpack16(&build_ptr->event_handler_poll_interval, buffer);
	safe_unpackstr_xmalloc(&build_ptr->slurm_event_handler,
			       &uint32_tmp, buffer);
	safe_unpackstr_xmalloc(&build_ptr->event_handler_logfile,
			       &uint32_tmp, buffer);
	/* nlk changes */
...
unpack_error:
	...
	/* nlk changes */
	xfree(build_ptr->slurm_event_handler);
	xfree(build_ptr->event_handler_logfile);
	/* nlk changes */
